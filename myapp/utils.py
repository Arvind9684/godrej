...
def get_project_list():
    projects_list = []
    project_data = projectTable.objects.select_related('project__city', 'project__sub_area', 'project__property_type', 'project__category', 'project__sub_category', 'project__website', 'project__publisher').all()
    ...
    for project in project_data:
        ...
        project_details = {
            ...
            "city": project.project.city.name if project.project and project.project.city else None,
        ...
        # Debug: Print project details to ensure data is correct
